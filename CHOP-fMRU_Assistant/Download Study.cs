...
{
    public partial class Download_Study : Form
    {
        public static string tempdir()
        {
            string dir;
            dir = AppDomain.CurrentDomain.BaseDirectory;
            dir += Properties.Settings.Default.CMove_dir;
            return dir;
        }
        ...
        public Download_Study()
        {
            ...
            this.Closed += new EventHandler(formclosed);
        }

        private void formshown(object sender, EventArgs e)
        {
            resulttosend = DialogResult.Cancel;
            configchange(this, null);
        }

        private DialogResult resulttosend;
        ...
        {
            toolStripStatusLabel2.Text = "Selected Network Configuration: " + configs.Current().Label;
            if (configtest != null)
            {
        ...
        private void CMove_series(gdcm.DataSetArrayType dsa)
        {
            ...
            */
            ...
            CMove_series_movescu = new movescu(configs.Current(), dsa, tempdir());
            Cmove_series_eventhandler = new DICOMNetworkEventHandler_Status(statuschange_CMove_series);
            CMove_series_movescu.StatusChange += Cmove_series_eventhandler;
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            if (listView1.SelectedItems.Count != 1) { 
                System.Windows.Forms.MessageBox.Show("Please select a patient.");
                return;
            }
            if (listView2.SelectedItems.Count != 1)
            {
                System.Windows.Forms.MessageBox.Show("Please select a study.");
                return;
            }
            if (listView3.SelectedItems.Count <= 0)
            {
                System.Windows.Forms.MessageBox.Show("Please select one or more series.");
                return;
            }
